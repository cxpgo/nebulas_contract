...
var QiPaiContract = function () {
    ...
    LocalContractStorage.defineMapProperty(this, "userRecharge", {
        stringify: function(obj) {
            return obj.toString();
        },
        parse: function(str) {
...
QiPaiContract.prototype = {
    ...
    _updateBalance:function(amount){
        this.balance = this.balance.plus(amount);
    },

    getBalance:function(isBigNumber){
        if(isBigNumber==true){
            return this.balance;
        }else{
            return this.balance.div(this.bigNumber);
        }
    },
    sendNas:function(){
        ...
        var balance = this.userRecharge.get(fromUser);
        if(!balance){
            this.userRecharge.set(fromUser,amount);
        }else{
            balance = balance.plus(amount);
            this.userRecharge.set(fromUser,balance);
        }
